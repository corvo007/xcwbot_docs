...
<b><font color="red">托管机器人</font>是指您自己托管于本平台享受服务的机器人或者我提供的用于查询、处理业务的机器人（如：448825087）。<font color="red">以下所有操作和指令 私聊任何托管机器人进行 或者 在任何托管机器人在的群聊进行 均可，有特别说明的除外（请不要私聊被冻结/离线的机器人）。</font></b>
...
<a-alert type="warning" message="注意" description="添加机器人至少需要有300云点(单群一个月的花费)。" show-icon />
<p></p>
<b>
